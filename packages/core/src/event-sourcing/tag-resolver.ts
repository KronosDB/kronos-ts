import type { Tag } from "../messaging/tag.js"
 ...
 * to events for filtering, categorization, and query-based sourcing.
 *
 ...
 */
export type TagResolver = (event: EventMessage) => Tag[]
...
export function descriptorBasedTagResolver(): TagResolver {
  return (event: EventMessage): Tag[] => [...event.tags]
}
