...
import { type SequencedDeadLetterQueue, deadLetter } from "../stores/dead-letter-queue.js"
import type { EventHandlerContext } from "../handlers/handler-context.js"
import type { UnitOfWork } from "../unit-of-work/unit-of-work.js"

/** One handler and the context built for it, for this event. */
export interface DeadLetteringTarget {
 ...
 */
export function deadLetteringDelivery(options: {
