...
export interface SequencedDeadLetterQueue {
  ...
  enqueue(processingGroup: string, letter: DeadLetter, uow?: UnitOfWork): Promise<void>
  ...
  contains(processingGroup: string, sequenceIdentifier: string, uow?: UnitOfWork): Promise<boolean>
  ...
  sequenceIdentifiers(processingGroup: string, uow?: UnitOfWork): Promise<string[]>
  ...
  size(processingGroup: string, uow?: UnitOfWork): Promise<number>

  /** Number of lanes with dead letters in the group. */
  amountOfSequences(processingGroup: string, uow?: UnitOfWork): Promise<number>

  /** Clear all dead letters in the group. */
  clear(processingGroup: string, uow?: UnitOfWork): Promise<void>
   ...
   */
  isFull(processingGroup: string, sequenceIdentifier: string, uow?: UnitOfWork): Promise<boolean>
}
