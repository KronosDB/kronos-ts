...
import type { StreamableEventSource, SequencedEvent, MessageStream } from "../source.js"
import type { EventHandler } from "../handler.js"
import { type TrackingToken, globalSequenceToken } from "../tracking-token.js"
// ---------------------------------------------------------------------------
// Test helpers
// ---------------------------------------------------------------------------
...
function runOver(config: {
  ...
  eventHandlers: ReadonlyArray<EventHandler<any>>
