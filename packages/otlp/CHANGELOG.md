...
- 848c5ae: `otlpHandler` traces `ctx.load`, `ctx.source`, `ctx.send` and `ctx.query`.
...
- 742a5d4: Metrics come with the handler span, and custom metrics are as easy as a log line.
